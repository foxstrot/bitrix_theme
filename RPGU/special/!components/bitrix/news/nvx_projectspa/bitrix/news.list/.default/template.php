...
<?endif?>
		<?if($arParams["DISPLAY_DATE"]!="N" && $arItem["DISPLAY_ACTIVE_FROM"]):?>
			Дата начала обсуждения: <span class="news-date-time"><?echo $arItem["DISPLAY_ACTIVE_FROM"]?></span><br>
		<?endif?>
		<?if($arParams["DISPLAY_DATE"]!="N" && $arItem["DATE_ACTIVE_TO"]):?>
			Дата окончания обсуждения: <span class="news-date-time"><?echo $arItem["DATE_ACTIVE_TO"]?></span><br><br>
		<?endif?>
		<?if ($hasPerm):?>
