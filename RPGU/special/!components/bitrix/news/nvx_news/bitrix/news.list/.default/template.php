...
'width':'700',
	'height':'400'})).Show();"><div class="btn_Add_Title">Добавить новость</div></div>
		<a class="btn_Add_Title" target=_self href="unpublished.php"><div class="btn_Add"><div class="btn_Add_Title">Неопубликованные</div></div></a>
		<p>&nbsp;</p>
...
<?if ($hasAdmPerm ):?>
	<?if ($arItem["ACTIVE"]=="" || $arItem["ACTIVE"]=="Y"):?>
		<a class="btn_Add_Title" target=_self href="unpublish.php?IBLOCK_ID=<?=$arItem["IBLOCK_ID"]?>&IBLOCK_TYPE=<?=$arResult["IBLOCK_TYPE_ID"]?>&ELEMENT_ID=<?echo $arItem['ID']?>"><div class="btn_Add"><div class="btn_Add_Title">Отменить публикацию</div></div></a>
	<?endif;?>
<?endif;?>
