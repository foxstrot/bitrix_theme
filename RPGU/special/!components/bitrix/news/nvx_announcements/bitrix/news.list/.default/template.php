...
'width':'700',
	'height':'400'})).Show();"><div class="btn_Add_Title">Добавить объявление</div></div>
	<p>&nbsp;</p>
...
<a name="<?=$arItem['ID']?>"></a>
		<?if($arParams["DISPLAY_DATE"]!="N" && $arItem["DISPLAY_ACTIVE_FROM"]):?>
			<span class="news-date-time"><?echo $arItem["DISPLAY_ACTIVE_FROM"]?></span><br><br>
		<?endif?>
		<?if ($hasPerm):?>
		<a class="fancypopup" href="#popupvacapan<?=$i?>">
		<?endif?>
		<?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
				<div class="news-list-title"><b><?echo $arItem["NAME"]?></b></div><br />
		<?endif;?>
