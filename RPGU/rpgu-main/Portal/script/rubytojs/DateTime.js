/* MODYDIED FILE date TO DateTime Generated by Opal 0.9.2 */
Opal.modules["DateTime"] = function(Opal) {
  ...
  return (function($base, $super) {
    function $DateTime(){};
    var self = $DateTime = $klass($base, $super, 'DateTime', $DateTime);
    ...
    (function(self) {
      ...
      Opal.defn(self, '$parse', function(string) {
		...
		match = /^(\d*).(\d*).(\d*)/.exec(string);
		if(match){
			return self.$wrap(new Date(parseInt(match[3], 10), parseInt(match[2], 10) - 1, parseInt(match[1], 10)));
		}
		return nil; 
      });       
	  Opal.defn(self, '$Parse', function(string) {
	  ...
	  Opal.defn(self, '$Now', function(string) {
        var self = this;
   ...
   Opal.defn(self, '$Month', function() {
	...
	Opal.defn(self, '$Date', function(days) {
      var self = this;

      return self.date;
    });
	
	Opal.defn(self, '$AddDays', function(days) {
      var self = this;
	  
	  var date = self.date;
	  var millisecondOffset = days * 24 * 60 * 60 * 1000;
	  date.setTime(date.getTime() + millisecondOffset); 
	  	  
      return self.date;
    });
	
	Opal.defn(self, '$ToJsNative', function(days) {
      var self = this;	  
