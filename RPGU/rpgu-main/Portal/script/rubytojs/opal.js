...
Opal.modules["corelib/string"] = function(Opal) {
  ...
  (function($base, $super) {
	...
	//¬от это € добавил, т.к. на носу релиз и € не успел узнать как в расширить модуль из вне
    Opal.defn(self, '$insert', function (position, other) {
    	var self = this;
    	other = $scope.get('Opal').$coerce_to(other, $scope.get('String'), "to_str");

	    return position > 0 ? self.substr(0, position) + other.$to_s() + self.substr(position, self.length) : self;
    });
...
Opal.modules["corelib/hash"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.alias(self, '$ContainsKey', 'has_key?');
